    ...
    if config.sub_folders:
        ...
        with open(log_file, mode='a', newline='') as file:
            ...
            if not file_exists:
                ...
                header.extend(["Total_images", "Num_clusters", "Num_samples_selected", 
                               "Feature_extraction_time(s)", "Clustering_time(s)", "Sampling_time(s)", 
                               "Overall_time(s)", "Date_time_processed", "Additional_note"])
        ...
        with open(log_file, mode='a', newline='') as file:
            ...
            # If the file does not exist, write the header
            if not file_exists:      
                writer.writerow(["WSI_Name", "Total_images", "Num_clusters", 
                                 "Num_samples_selected", "Feature_extraction_time(s)", 
                                 "Clustering_time(s)", "Sampling_time(s)", "Overall_time(s)", 
                                 "Date_time_processed", "Additional_note"]) 
